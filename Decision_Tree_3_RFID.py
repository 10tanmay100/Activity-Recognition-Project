...
lg=logging_file.define_logger("logger_3_RFID_Decision_Tree")
lg.basic_config()
#reading the dataset
try:
    df=pd.read_csv("E:\\ml project\\classification project\\Activity Recognition\\cleaned_data\\3_RFID.csv")
